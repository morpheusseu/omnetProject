...
#define batteryCapacity 100000000  //unit unknown
...
#define alpha 1 //when messages be transfered : alpha*byte*scope
#define beta 1 //when messages be received : beta*byte*scope
#define gamma 1 //for listening stage : gamma*time
#define delta 1 //for sleeping stage : delta*time
//end
